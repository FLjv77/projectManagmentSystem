...
@Component({
  selector: 'app-edite-progress-report-information',
  templateUrl: './edite-progress-report-information.component.html',
  styleUrls: ['./edite-progress-report-information.component.scss',
    '../../../../createProjectProcess/page/project-creation-levels/project-creation-levels.component.scss']
})
export class EditeProgressReportInformationComponent implements OnInit {
